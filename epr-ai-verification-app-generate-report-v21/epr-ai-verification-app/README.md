...
## AI verification password

The AI verification endpoint checks `AI_VERIFY_PASSWORD`. The app package defaults to `HotHoney` if the environment variable is not set, but setting the variable in Vercel is recommended.
